...
- If it's not reported yet, [create a new issue](https://github.com/ryonakano/atlas/issues/new).
...
- Perform changes
    - Write a release note in `data/atlas.metainfo.xml.in`
...
- Create a new branch named `com.github.ryonakano.atlas-X.Y.Z`
- Perform changes
